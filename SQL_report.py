...
where d.d_emissione between [inizio_emissione:D:01/01/2013] and [inizio_emissione:D:01/02/2013]  
...
where d.d_emissione between [inizio_emissione:D:01/01/2013] and [fine_emissione:D]  
and d.id_stato < 1000 and dp.fl_virtuale = 'N'
    and d.id_fornitore = [#AZIENDA] 
group by d.id_documento,
         dp.d_periodo,
         SEZ.S_CAUSALE_REG,
         dp.s_pod_pdr,
